...
export let post = (state = card, action) => {
    if (action.type === 'ids') {
        let card_now = card.style_tatoo_card_filter.filter(card => card.id == action.id)
        return {
            ...state,
            card_noww: card_now
        }
    ...
    if (action.type === 'sort_plus') {
        if (action.value == 'name+') {
            console.log(state.style_tatoo_card_filter)
            // let a = card.style_tatoo_card.sort((a, b) => a.name.localeCompare(b.name))
            return {
                ...state,
                style_tatoo_card_filter: [...card.style_tatoo_card_filter.sort((a, b) => a.name.localeCompare(b.name))]
            }
        }
        else {
            console.log(state.style_tatoo_card_filter)
            return {
                ...state,
                style_tatoo_card_filter: [...card.style_tatoo_card_filter.sort((a, b) => b.name.localeCompare(a.name))]
            }
        }
    }
    if (action.type === 'search') {
        console.log(state.style_tatoo_card_filter)
        console.log(state.style_tatoo_card)
        return {
            ...state,
            style_tatoo_card_filter: [...card.style_tatoo_card_filter.filter((name) => name.name.toLowerCase().includes(action.text.toLowerCase()))]
        }
    }
...
// export function ids (id) { //чаще используется при запросах на сервер
//     return function (dispatch) {
//         dispatch({ type: 'ids', id: id })
//     }
// }
